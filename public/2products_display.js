...
window.onload = function() {
    ...
    setProductDetailsAndValidateInputs();

    // ... other window.onload logic ...
};

// Set initial values for product details and validate inputs
function setProductDetailsAndValidateInputs() {
