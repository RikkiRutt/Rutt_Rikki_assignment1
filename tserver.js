...
// Broadcast function to send data to all connected clients (dynamic update)
...
// Listen for connections(dynamic update change)
...
app.post("/process_purchase", function(request, response) { 
	...
	for (let i in products) {
		...
		products[i].qty_available = products[i].qty_available -qty;
 		...
 		// Broadcast the updated inventory to all connected clients (dinamic update change)
